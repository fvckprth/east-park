    ...
    return (
        ...
        <div>
          <p className="text-custom-white text-base md:text-2xl mb-1 md:mb-2">
            building ⎯{' '}
            <a href="https://www.withamaya.com" className="underline underline-offset-4 md:underline-offset-8 decoration-from-font hover:opacity-50 hover-italic">Amaya</a>,{' '}
        ...
        <div className="flex items-center space-x-1 mb-1 md:mb-2">
          ...
          <p className="text-custom-white text-base md:text-2xl" style={{ fontFamily: 'var(--font-pp-light-italic)' }}>
            <a href="mailto:info@eastpark.xyz" className="decoration-from-font">info[at]eastpark.xyz</a>
          </p>
        </div>
