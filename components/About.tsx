function About() {
    return (
        ...
        <div className="flex items-center space-x-0 mb-0 md:mb-1">
          {/* Mobile Version */}
          <img src="/assets/copyright.svg" alt="Copyright" className="pb-1.5 block md:hidden h-5"/>
          {/* Desktop Version */}
          <img src="/assets/copyright.svg" alt="Copyright" className="pb-1.5 hidden md:block h-6"/>
          <p className="text-custom-white text-base md:text-xl">
            <span className="text-custom-white text-xl md:text-2xl" style={{ fontFamily: 'var(--font-gracia)' }}>East Park,</span>{' '}Holdings
          </p>
        </div>
        <div>
          <p className="text-custom-white text-base md:text-xl mb-1 md:mb-2">
            building ⎯{' '}
        ...
        <div className="flex items-center space-x-1 mb-1 md:mb-2">
          ...
          <p className="text-custom-white text-base md:text-xl">1.968.213.1203</p>
        </div>
        <div className="flex items-center space-x-1 mb-1 md:mb-2">
          <img src="/assets/email.svg" alt="Email" className="pb-1.5 h-5 md:h-7"/>
          <p className="text-custom-white text-base md:text-xl" style={{ fontFamily: 'var(--font-pp-light-italic)' }}>
        ...
        <div className="flex items-center space-x-2">
          ...
          <p className="text-custom-white text-base md:text-xl">
            10002, <span className="text-xl md:text-2xl" style={{ fontFamily: 'var(--font-gracia)' }}>New York City</span>
          </p>
        </div>
      </div>
    );
